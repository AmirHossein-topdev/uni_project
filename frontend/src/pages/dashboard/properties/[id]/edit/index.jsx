// frontend/src/pages/dashboard/properties/[id]/edit/index.jsx
"use client";
  ...
  useEffect(() => {
    ...
    const fetchProperty = async () => {
      ...
      try {
        ...
        console.log("داده کامل برگشتی از سرور:", data);
        console.log("کلیدهای data:", Object.keys(data));
        console.log(
          "کلیدهای sections (اگر موجود):",
          Object.keys(data.sections || {}),
        );

        dispatch(setStatus(property || {}));
        dispatch(setIdentity(sections.PropertyIdentity || {}));
        dispatch(setLegalStatus(sections.PropertyLegalStatus || {}));
        dispatch(setOwnership(sections.PropertyOwnership || {}));
        dispatch(setLocation(sections.PropertyLocationInfo || {}));
        dispatch(setBoundaries(sections.PropertyBoundariesInfo || {}));
        dispatch(setAdditionalInfo(sections.PropertyAdditionalInfo || {}));

        console.log("Draft بعد از fetch و dispatch:");
        console.log({
          status: data.status || {},
